<!-- E:\call_center\app\Views\partner\commissions.php -->
<div class="card border-0 shadow-sm mt-2">
    <div class="card-header bg-white fw-semibold"><i class="bi bi-currency-euro me-1 text-success"></i> My Commissions (Partner)</div>
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                <thead class="table-light">
                    <tr><th>Business</th><th>Deal Amount</th><th>Commission</th><th>Rate</th><th>Status</th><th>Date</th></tr>
                </thead>
                <tbody>
