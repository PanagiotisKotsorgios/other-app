<div class="card border-0 shadow-sm mt-2">
    <div class="card-header bg-white fw-semibold"><i class="bi bi-currency-euro me-1 text-success"></i> Οι Προμήθειές Μου (Προγραμματιστής)</div>
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                <thead class="table-light">
                    <tr><th>Επιχείρηση</th><th>Έργο</th><th>Ποσό Συμφωνίας</th><th>Προμήθεια</th><th>Ποσοστό</th><th>Κατάσταση</th><th>Ημερομηνία</th></tr>
                </thead>
                <tbody>
