...
<div class="row justify-content-center mt-2">
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white fw-semibold"><i class="bi bi-bag-plus me-1 text-success"></i>Υποβολή Συμφωνίας για <?= htmlspecialchars($business['company_name']) ?></div>
            <div class="card-body">
                <form method="POST" action="<?= APP_URL ?>/caller/deals" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Υπηρεσία / Προϊόν <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Ποσό Συμφωνίας (€) <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <div class="alert alert-success py-2">
                            <small>Η προμήθειά σας (<?= COMMISSION_RATE ?>%): <strong id="commPreview">€0.00</strong></small>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Ανέβασμα Πρότασης (προαιρετικά)</label>
                        <input type="file" name="proposal_file" class="form-control" accept=".pdf,.doc,.docx">
                        <div class="form-text">Μόνο PDF ή DOC, μέγ. <?= UPLOAD_MAX_SIZE/1048576 ?>MB</div>
                    </div>

                    <div class="d-flex gap-2">
                        <button class="btn btn-success"><i class="bi bi-send me-1"></i>Υποβολή Συμφωνίας</button>
                        <a href="<?= APP_URL ?>/caller/businesses/<?= $business['id'] ?>" class="btn btn-outline-secondary">Ακύρωση</a>
                    </div>
                </form>
            </div>
        </div>
