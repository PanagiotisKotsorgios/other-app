                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select name="is_active" class="form-select">
                                <option value="1" <?= $developer['is_active'] ? 'selected' : '' ?>>Ενεργός</option>
                                <option value="0" <?= !$developer['is_active'] ? 'selected' : '' ?>>Ανενεργός</option>
                            </select>
                        </div>
                        <div class="col-sm-3">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="stat-box text-center">
                    ...
                    <div class="stat-lbl">Ποσοστό Προμήθειας Προγραμματιστή</div>
                </div>
                <?php else: ?>
                <div class="text-center text-muted py-3 text-sm">
                    <i class="bi bi-award fs-2 d-block mb-2 opacity-25"></i>
                    Χωρίς κατηγορία.<br>Χρήση καθολικού ποσοστού (<?= defined('DEVELOPER_COMMISSION_RATE') ? DEVELOPER_COMMISSION_RATE : 20 ?>%).
                </div>
                <?php endif ?>
            </div>
        </div>
